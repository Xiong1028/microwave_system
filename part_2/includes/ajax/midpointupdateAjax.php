...
if (!is_null($midDataArr['midpointid'])) {
	...
	if (count($err_mid_data)) {
		...
		$qry = "UPDATE path_midPoints SET grd_height =" . $midDataArr['midgheight'] . ", trn_type = '" . $midDataArr['midtrntype'] . "', obstr_height=" . $midDataArr['midobheight'] . ", obstr_type='" . $midDataArr['midobtype'] . "' WHERE path_midpt_ID=" . $midDataArr['midpointid'] . ";";
